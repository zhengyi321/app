package com.gototongcheng.widget.tab;
...
import static com.gototongcheng.application.R.color.black;
...
public class PluginScrollView extends RelativeLayout{
	...
	public void buttonSelected(int position){
		...
		if(currentSelectedButton != -1){
			...
			getButtonInLayout(currentSelectedButton).setBackgroundResource(R.color.white);
		}
