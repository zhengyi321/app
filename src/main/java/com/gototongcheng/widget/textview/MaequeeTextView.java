 ...
 */
public class MaequeeTextView extends TextView implements Runnable {
    ...
    public MaequeeTextView(Context context) {
        super(context);
    }


    public MaequeeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }


    public MaequeeTextView(Context context, AttributeSet attrs, int defStyle) {
