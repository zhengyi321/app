package com.gototongcheng.widget.imageview;
...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener
{
    ...
    private int mIndicatorBackgroundResId = R.drawable.shape_green_radius;

    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs)
    {
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.shape_green_radius);
     //                   R.drawable.shape_white_radius);
  ...
  //                      mIndicatorBackgroundResId);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin)
    {
        ...
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.shape_green_radius, R.drawable.shape_white_radius);
    }
